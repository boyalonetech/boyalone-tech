...
const ProjectCard = () => {
  ...
  return (
    <div className="flex flex-col mt-12 px-4" id="projects">
      <h1 className="2xl font-bold center mb-6">My Projects</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-blue-500 to-blue-500 white transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out p-4 flex flex-col justify-end">
              <h3 className="lg font-semibold mb-1">{project.title}</h3>
              <p className="sm white/80 mb-3 leading-snug line-clamp-3">
                {project.description}
              </p>
              <a
                ...
                className="self-start px-4 py-1.5 bg-white black sm font-medium rounded-full hover:bg-gray-200 transition"
              >
                View Demo
              </a>
            </div>
