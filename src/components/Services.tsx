      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {services.map((service, index) => (
          ...
          >
            ...
            <h3 className="lg font-semibold gray-800 mb-2 group-hover:blue-600">
              {service.title}
            </h3>
            <p className="gray-600 sm">{service.description}</p>
          </div>
        ))}
      </div>
    </div>
